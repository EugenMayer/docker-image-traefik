...
- TRAEFIK_ACME_CHALLENGE_DNS_CREDENTIALS=""             # Set you credentials needed for your DNS provider. Use a `key1=value1;key2=value2` syntax, e.g. for Cloudflare `CLOUDFLARE_MAIL=aasdas@gmx.de;CLOUDFLARE_API_KEY=adqweq121` - see [the traefik documentation](https://docs.traefik.io/configuration/acme/#provider) for the avaiable keys
